    ...
    <div>
      <section className="">
        <div className="bg-[url('https://images.ctfassets.net/yr4qj72ki4ky/1Qm1FWaixBp2nbrIH5ocP6/084e35ebb847dcfc07fb1062417a9332/heroimageHackReactor.jpg?q=72')] flex flex-col w-screen h-96 bg-no-repeat bg-cover big-fit bg-center object-none items-center justify-center text-center text-white font-serif md:h-screen px-30 bg-left">
          ...
          <p className="sm:invisible md:visible text-xl font-sans">
            Since 2012, Hack Reactor has developed over 8,000+ job-ready
            software engineers.
          </p>
          <p className="sm:invisible md:visible text-xl font-sans mt-5">
            Reinvent your career with us.
          </p>
        </div>
      </section>
      <section className="grid  bg-alto-500 grid  grid-cols-2 p-4 font-serif text-sm md:grid-cols-4 gap-y-4">
      ...
      <section>
        <div className="flex flex-col items-center  justify-center text-center  font-serif mt-14 text-3xl">
          ...
          <div className="hidden text-base font-sans mt-8 px-44 md:block">
            <p>
